...
- Download the current upstream OpenAI OpenAPI spec from https://app.stainless.com/api/spec/documented/openai/openapi.documented.yml and update the openapi.yaml file in this git repo

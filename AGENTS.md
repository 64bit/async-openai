...
Deprecation:
- do not update previously deprecated and legacy apis and types like Assistants, Realtime Beta, and Completions
- When a previously deprecated API no longer exist remove it from the code

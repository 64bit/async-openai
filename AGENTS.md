...
- Download the current upstream OpenAI OpenAPI spec from https://raw.githubusercontent.com/openai/openai-openapi/master/openapi.yaml and update the openapi.yaml file in this git repo

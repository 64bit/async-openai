...
pub enum Item {
    ...
    /// A tool search step that loads deferred tools into the model's context.
    ToolSearchCall(ToolSearchCall),

    /// The output of a function tool call.
    FunctionCallOutput(FunctionCallOutputItemParam),

    /// The loaded tool definitions returned by a tool search step.
...
pub enum Tool {
    ...
    /// Groups tools under a shared namespace.
...
/// A function tool that belongs to a namespace.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq)]
#[serde(tag = "type", rename_all = "snake_case")]
...
pub struct NamespaceTool {
    ...
    /// The tools available inside this namespace.

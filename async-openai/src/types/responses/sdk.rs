use crate::types::responses::{
    ApplyPatchToolCallItemParam, ApplyPatchToolCallOutputItemParam, CodeInterpreterTool,
    CodeInterpreterToolCall, ComputerCallOutputItemParam, ComputerToolCall, ComputerUsePreviewTool,

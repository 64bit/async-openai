...
impl From<OutputItem> for InputItem {
    fn from(item: OutputItem) -> Self {
        match item {
            ...
            OutputItem::FileSearchCall(c) => Item::FileSearchCall(c.into()).into(),
            OutputItem::FunctionCall(c) => Item::FunctionCall(c.into()).into(),
            OutputItem::FunctionCallOutput(o) => Item::FunctionCallOutput(o.into()).into(),
            OutputItem::WebSearchCall(c) => Item::WebSearchCall(c.into()).into(),
            OutputItem::ComputerCall(c) => Item::ComputerCall(c.into()).into(),
            OutputItem::ComputerCallOutput(o) => Item::ComputerCallOutput(o.into()).into(),
            OutputItem::Reasoning(r) => Item::Reasoning(r.into()).into(),
            OutputItem::Compaction(c) => Item::Compaction(c.into()).into(),
            OutputItem::ImageGenerationCall(c) => Item::ImageGenerationCall(c.into()).into(),
            OutputItem::CodeInterpreterCall(c) => Item::CodeInterpreterCall(c.into()).into(),
            OutputItem::LocalShellCall(c) => Item::LocalShellCall(c.into()).into(),
            ...
            OutputItem::McpCall(c) => Item::McpCall(c.into()).into(),
            OutputItem::McpListTools(c) => Item::McpListTools(c.into()).into(),
            OutputItem::McpApprovalRequest(c) => Item::McpApprovalRequest(c.into()).into(),
            OutputItem::CustomToolCall(c) => Item::CustomToolCall(c.into()).into(),

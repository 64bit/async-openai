...
#[builder(
    name = "CreateResponseRequestArgs",
    pattern = "mutable",
    setter(into, strip_option),
    default
)]
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default, Builder)]
#[builder(
    name = "ResponsesCodeInterpreterArgs",
    pattern = "mutable",
    setter(into, strip_option),
    default
)]
#[builder(build_fn(error = "OpenAIError"))]
pub struct ResponsesCodeInterpreter {
